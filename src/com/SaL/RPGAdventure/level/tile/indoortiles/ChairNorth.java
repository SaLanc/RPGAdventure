...
public class ChairNorth extends Tile {

	public ChairNorth(Sprite sprite) {
	...
	public void Regester(int x, int y) {
		...
		loc[x][y] = IndoorTiles.chairnorth;
	...
	public void render(int x, int y, Screen screen) {
		...
		screen.renderTile(x << 4, y << 4, IndoorTiles.chairnorth1);

	}
	public void toprender(int x, int y, Screen screen){
		screen.renderTile(x << 4, y << 4, IndoorTiles.chairnorth);
	}
